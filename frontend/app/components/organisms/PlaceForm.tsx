...
const PlaceForm = (
  ...
  return (
    ...
    keyboardShouldPersistTaps='handled'>
        ...
        <AppSwitch label='Does it requiere an entry fee?' value={formData.requires_entry_fee} toggleSwitch={() => updateField('requires_entry_fee', !formData.requires_entry_fee)} />
